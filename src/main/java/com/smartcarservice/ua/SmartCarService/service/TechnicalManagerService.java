...
public interface TechnicalManagerService {
    ...
    public abstract void updateTechnicalManager(TechnicalManager technicalManager);
    public abstract void updateTechnicalManager(TechnicalManagerDto technicalManagerDto);
