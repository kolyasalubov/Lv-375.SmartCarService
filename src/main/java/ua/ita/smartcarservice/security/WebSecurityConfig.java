...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                .authorizeRequests()
                .antMatchers(HttpMethod.GET, "/api/v1/skillbycar/**").permitAll()
                .antMatchers(HttpMethod.GET, "/api/v1/findrequiredtime/**").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/workerbyskill").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/workerbycar/**").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/newbooking").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/bookingbyid").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/bookingtime").permitAll()
