...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.csrf().disable()
                ...
                .antMatchers("/api/chart/**", "/api/report/**", "/api/techservices/**", "/api/owner/**", "/api/car/**", "/api/newcar/**", "/api/workers/**", "/api/works/**", "/api/booking/**", "/api/notifications/**", "/api/users/**", "/api/report", "/api/inspection/**").hasAuthority(Roles.ROLE_CAR_OWNER.toString())
